...
- (void)fetchData
{
    ...
    for (int i = 0; i < CELL_COUNT ; i++) {
        ...
        NSString *fileName = [NSString stringWithFormat:@"iu%d",i+1];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView
    ...
    float height = [self.cellHeights[indexPath.item] floatValue];
    
    UIImageView *imageView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, self.cellWidth, height)];
    
    
    NSLog(@"Width : %f Height %f",self.cellWidth,height);
